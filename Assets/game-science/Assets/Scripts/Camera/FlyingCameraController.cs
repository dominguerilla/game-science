...
namespace FlyingCamera
{
    ...
    public class FlyingCameraController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            {
                transform.position = transform.position + (m_Camera.transform.forward * speed * Time.deltaTime);
            }

            if (Input.GetKey(KeyCode.A))
            {

                transform.position = transform.position + (m_Camera.transform.right * -1.0f *  speed * Time.deltaTime);
            }

            if (Input.GetKey(KeyCode.S))
            {

                transform.position = transform.position + (m_Camera.transform.forward * -1.0f * speed * Time.deltaTime);
            }
