...
public class MyCamera : MonoBehaviour
{
    ...
    // zoom
    public float zoomSpeed = 5.0f; // the zoom speed multiplier
    public float zoomMaxLimit = 20.0f; // max limit value(distance between camera and focuspoint)
    public float zoomMinLimit = 5.0f; // min limit value(distance between camera and focuspoint)
    // rotate around
